...
const Expenses = () => {
  ...
  function handleDelete(id){
    ...
    .then((res)=>dispatch(fetchExpenses()))
  ...
  if(search) filteredData=filteredData.filter((ele)=>ele.billType.includes(search) || ele.reciver.includes(search) || ele.date.includes(search))
  return (
    <div style={{direction:i18n.language=='en'?"ltr":"rtl"}}>
    {(user.admin || (user.permissions&&user.permissions.expenses))?
      <div className="cont">
    ...
    <div className="search-box">  
      ...
      <Button onClick={handleOpen} variant='contained' className='btn'>{t("finance.addExpenses")}</Button>
    </div>
      ...
      <Table  aria-label="simple table">
        <TableHead className='tablehead'>
          <TableRow >
            ...
            <TableCell align='center' className='table-row'>{t("finance.pillType")}</TableCell>
        ...
        <TableBody>
          ...
          <AddExpenses handleClose={handleClose} data={temp} handleOpen={handleOpen} open={open} update={update}/>
