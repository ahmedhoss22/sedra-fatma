...
function CanceledReservations({handleClose,handleOpen,open,startDate,endDate}) {    
  const { t, i18n } = useTranslation();
  const dispatch=useDispatch()
 let data=useSelector((state)=>state.reservation.value.canceled)
 useEffect(()=>{
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead className='tablehead'>
                <TableRow >
                  ...
                  {/* <TableCell align='center' className='table-row'>رقم العقد </TableCell> */}
                  ...
                  {/* <TableCell align='center' className='table-row'>ايرادات</TableCell> */}
